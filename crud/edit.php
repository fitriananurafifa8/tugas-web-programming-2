...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="tambah.php"><font color=blue>Tambah Data</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container" style="margin-top:20px">
    <font color=saddlebrown><h2>Edit Data Siswa</h2>
    ...
    if(isset($_GET['id'])){
      ...
      $select = mysqli_query($koneksi, "SELECT * FROM data_siswa WHERE id='$id'") or die(mysqli_error($koneksi));
    ...
    if(isset($_POST['submit'])){
      ...
      $sql = mysqli_query($koneksi, "UPDATE data_siswa SET nama='$nama', username='$username', password='$password', email='$email' WHERE id='$id'") or die(mysqli_error($koneksi));
    ...
    <form action="edit.php?id=<?php echo $id; ?>" method="post">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <a href="index.php" class="btn btn-danger"><font color=white><-</a>
